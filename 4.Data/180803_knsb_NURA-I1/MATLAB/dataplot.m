...
% Initial state
tilt = 85 * pi/180;
Phi(1)  = 0;        Theta(1)  = -pi+tilt; Psi(1)  = 0; %Theta(1)  = -pi/2+tilt; Psi(1)  = 0;
EPhi(1) = Phi(1);   ETheta(1) = -tilt;   EPsi(1) = Psi(1); %ETheta(1) = Theta(1);   EPsi(1) = Psi(1);
